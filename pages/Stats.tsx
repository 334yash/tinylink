...
export const Stats: React.FC = () => {
  ...
  // Mock data for the chart since the simple DB only stores total clicks
  const mockChartData = [
  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in duration-500">
      <div className="flex items-center gap-2 mb-6 text-sm text-slate-500">
        <RouterLink to="/" className="hover:text-primary-600 transition-colors">&larr; Back to Dashboard</RouterLink>
        <span>/</span>
        <span>Stats</span>
      </div>
